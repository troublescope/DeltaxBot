...
@Client.on_callback_query(devs_only & filters.regex(r"^btn_"))
...
@Client.on_message(devs_only & filters.command(["e", "eval"]))
...
@Client.on_message(devs_only & filters.command("sh"))
